    ...
    return (
      <>
        ...
        <View style={[
          ...
          {item.sender === 'system' && (
            <Image 
              source={require('/Users/hrikisschitrakar/Desktop/Vrikshya-Rakshya/frontend/assets/images/logo.png')} // Add your app logo
              style={styles.avatarImage}
              defaultSource={require('/Users/hrikisschitrakar/Desktop/Vrikshya-Rakshya/frontend/assets/images/logo.png')}
            />
          )}
          <View style={[
